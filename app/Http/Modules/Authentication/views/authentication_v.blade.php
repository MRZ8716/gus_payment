...
@push('styles')
    <style nonce="{{ Vite::cspNonce() }}"></style>
@endpush
                        ...
                        <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
                            ...
                            <div class="d-flex justify-content-center py-4">
                                <a href="index.html" class="logo d-flex align-items-center w-auto">
                                    ...
                                    <span class="d-none d-lg-block">TIKET GRESIK</span>
                                </a>
                            </div><!-- End Logo -->
                            ...
                            <div class="card mb-3">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="pt-4 pb-2">
                                        ...
                                        <p class="text-center small">Tiket Payment</p>
                                    </div>
...
@push('scripts')
    <script nonce="{{ Vite::cspNonce() }}"></script>
@endpush
